...
#define MY_PLUGIN_NAME      "VATPRC VFPC"
#define MY_PLUGIN_VERSION   "1.2"
#define MY_PLUGIN_DEVELOPER "Ran Chen, Justin Wai, Jamie Kong, Jan Fries, Hendrik Peter, Sven Czarnian"
#define MY_PLUGIN_COPYRIGHT "GPL v3"
#define MY_PLUGIN_VIEW_AVISO  "VATPRC FlightPlan Checker"

#define PLUGIN_WELCOME_MESSAGE	"Welcome to the VATPRC Flight Plan Checker"
